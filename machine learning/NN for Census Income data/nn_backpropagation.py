...
def main():
    ...
    #print("Final data\n", train_new)
    #print("Shape of train data", np.shape(train_new))
    ...
    #print("Shape of test data", np.shape(test_new))
...
def build_model(nn_hdim, mat, y, num_passes, print_loss=False):
    ...
    for i in range(0, num_passes):
        ...
        W1 += (-epsilon) * dW1             # Normal gradient descent
        
        #W1 += mu * v + (-epsilon) * dW1   # using momentum
